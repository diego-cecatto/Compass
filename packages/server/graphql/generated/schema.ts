...
> = {
    ...
    dependencies?: Resolver<
        Maybe<Array<Maybe<ResolversTypes['Dependencies']>>>,
        ParentType,
        ContextType
    >;
...
export type DefaultValueDescriptorResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['DefaultValueDescriptor'] = ResolversParentTypes['DefaultValueDescriptor']
> = {
    computed?: Resolver<
...
export type DependenciesResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['Dependencies'] = ResolversParentTypes['Dependencies']
> = {
...
export type DictionaryResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['Dictionary'] = ResolversParentTypes['Dictionary']
> = {
...
> = {
    defaultValue?: Resolver<
        Maybe<ResolversTypes['DefaultValueDescriptor']>,
        ParentType,
        ContextType
    >;
    description?: Resolver<
...
> = {
    component?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<QueryComponentArgs, 'filePath'>
    >;
    components?: Resolver<
        Array<Maybe<ResolversTypes['Component']>>,
        ParentType,
        ContextType,
        Partial<QueryComponentsArgs>
    >;
    documentation?: Resolver<
        Maybe<ResolversTypes['String']>,
        ParentType,
        ContextType,
        Partial<QueryDocumentationArgs>
    >;
    documentationDefault?: Resolver<
        Maybe<ResolversTypes['String']>,
        ParentType,
        ContextType
    >;
